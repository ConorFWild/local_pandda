...
def get_affinity_background_corrected_density(
    ...
    dataset_min_x = max([0, index[0]-math.ceil(fragment_shape[0]/2)])
    dataset_min_y = max([0, index[1]-math.ceil(fragment_shape[1]/2)])
    dataset_min_z = max([0, index[2]-math.ceil(fragment_shape[2]/2)])
    ...
    fragment_min_x = max([0,  math.ceil(fragment_map.shape[0]/2)-index[0]])
    fragment_min_y = max([0,  math.ceil(fragment_map.shape[1]/2)-index[1]])
    fragment_min_z = max([0,  math.ceil(fragment_map.shape[2]/2)-index[2]])
