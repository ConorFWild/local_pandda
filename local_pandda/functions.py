...
def get_affinity_background_corrected_density(
    ...
    fragment_min_x = max([0,  index[0]-math.floor(fragment_map.shape[0]/2)])
    fragment_min_y = max([0,  index[0]-math.floor(fragment_map.shape[1]/2)])
    fragment_min_z = max([0,  index[0]-math.floor(fragment_map.shape[2]/2)])
